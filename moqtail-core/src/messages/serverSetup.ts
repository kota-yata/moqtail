...
import { concatUint8Arrays, serializeQuicVarInt, deserializeQuicVarInt, setUint16, getUint16 } from "bytes";
...
export const serializeServerSetup = (props: ServerSetup) => {
  ...
  const length = setUint16(concatUint8Arrays([selectedVersion, params]).byteLength);
